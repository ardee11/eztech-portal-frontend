                  ...
                  <div className="bg-blue-100 px-5 py-4 3xl:px-6 border-b border-gray-100">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center space-x-2 3xl:space-x-3">
                        <div className="w-8 h-8 3xl:w-10 3xl:h-10 bg-blue-200 rounded-full flex items-center justify-center">
                          <svg className="w-4.5 h-4.5 3xl:w-5 3xl:h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all duration-300">
                    <div className="bg-blue-100 px-6 py-4 border-b border-gray-100">
                      <div className="flex items-center space-x-2 3xl:space-x-3">
                        ...
                        <h2 className="text-md 3xl:text-xl font-bold text-gray-900">Serial Numbers</h2>
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full">
                        <thead className="bg-gray-50">
                          <tr>
                            <th className="px-6 py-2.5 3xl:py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider w-1/4">
                              Serial No.
                            </th>
                            <th className="px-6 py-2.5 3xl:py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider w-1/2">
                              Status
                            </th>
                            <th className="px-6 py-2.5 3xl:py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider w-1/4">
                              Notes
                            ...
                            <tr key={serial.id} className="hover:bg-blue-50/50 transition-all duration-200 group">
                              <td className="px-6 py-4 whitespace-nowrap">
                                <div className="flex items-center space-x-3">
                                  ...
                                  <span className="font-semibold text-xs 3xl:text-base text-gray-900 group-hover:text-blue-600 transition-colors">{serial.id}</span>
                                </div>
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap">
                                <div className="flex flex-wrap gap-2">
                                  {serial.remarks === "Good" ? (
                                    <>
                                      <span className="inline-flex items-center px-2 py-1 3xl:px-3 rounded-full text-xs font-semibold bg-emerald-100 text-emerald-800 border border-emerald-200">
                                        <svg className="w-3 h-3 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                        </svg>
                                        Checked
                                      </span>
                                      <span className="inline-flex items-center px-2 py-1 3xl:px-3 rounded-full text-xs font-semibold bg-emerald-100 text-emerald-800 border border-blue-200">
                                        <svg className="w-3 h-3 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                        </svg>
                                        Passed
                                      </span>
                                      <span className="inline-flex items-center px-2 py-1 3xl:px-3 rounded-full text-xs font-semibold bg-emerald-100 text-emerald-800 border border-green-200">
                                        <svg className="w-3 h-3 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                        </svg>
                                        Good
                                      </span>
                                      <span className="inline-flex items-center px-2 py-1 3xl:px-3 rounded-full text-xs font-semibold bg-emerald-100 text-emerald-800 border border-purple-200">
                                        <svg className="w-3 h-3 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <span className="inline-flex items-center px-2 py-1 3xl:px-3 rounded-full text-xs font-semibold bg-red-100 text-red-800 border border-red-200">
                                      <svg className="w-3 h-3 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                              ...
                              <td className="px-6 py-4 text-xs 3xl:text-sm text-gray-700">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all duration-300">
                  ...
                  <div className="px-6 py-4 3xl:py-5">
                    <div className="prose prose-sm max-w-none">
                      <p className="text-gray-700 text-xs 3xl:text-sm leading-relaxed break-words whitespace-pre-wrap min-h-[120px]">
                        {item?.notes || (
                  ...
                  <div className="bg-blue-100 px-4 py-4 border-b border-gray-100">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center space-x-2">
                        ...
                        <h2 className="text-md 3xl:text-xl font-bold text-gray-900">Status</h2>
                      </div>
                    ...
                    <div className="mb-4">
                      ...
                      {item?.item_status === "Pending" && (
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                          <div className="flex items-center justify-between mb-2">
                            <h4 className="text-md 3xl:text-lg font-bold text-gray-900">Pending</h4>
                      ...
                      {item?.item_status === "Delivered" && (
                        <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                          <div className="flex items-center justify-between mb-2">
                            <h4 className="text-md 3xl:text-lg font-bold text-gray-900">Delivered</h4>
                            <span className="bg-green-100 text-green-800 text-xs font-semibold px-2.5 py-0.5 rounded-full">
                              ✓ Complete
                            </span>
                          </div>
